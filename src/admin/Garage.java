package admin;
import vehicles.*;
import user.LoggerAndParkingPayment;
...
public class Garage{
    ...
    public static void deleteCar(Vehicle vehicle,boolean deleteImageFromDir)
    {
        ...
        if(LoggerAndParkingPayment.entryDate.containsKey(vehicle.licensePlate))
            LoggerAndParkingPayment.entryDate.remove(vehicle.licensePlate);
