...
public class UserProgram {
    ...
    public static ArrayList<Integer> stopTraffic=new ArrayList<>();
    ...
    public static void setMinimumVehicles(int number) throws Exception
    {
        ...
        {
           //dio sam platformama po redu
           // if(Garage.getPlatform(GUI.currentPlatform).freeSpace==0)
           //   GUI.currentPlatform=Garage.getNextFreePlatformNumber();
            
            //dio sam random platformom
            while(true)
            {
            ...
            if(random.nextInt(10)==0)
            {
                ...
                {
                  case 0:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new AmbulanceVan(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null,0));break;} 
                  case 1:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new PoliceVan(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null,0)); break;}
                  case 2:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new FireTruck(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null,0)); break;}  
                  case 3:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new AmbulanceCar(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null,0));break;}  
                  case 4:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new PoliceCar(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null,0));break;}
                  case 5:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new PoliceBike(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null)); break;}
                }
            }
            else
            {
                ...
                {
                    case 0:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new Van(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null,0)); break;}
                    case 1:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new Car(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null,0)); break;}
                    case 2:{Garage.getPlatform(GUI.currentPlatform).setCarOnFreeSpace(new Bike(vehicleName+String.valueOf(i),license+String.valueOf(i),"//","//",null)); break;}
                }
            }
        }
    }
    ...
    public static void userSimulation()
    {
        ...
        Runnable r = () -> {
            ...
            if(threads.isEmpty())
               { 
                   Garage.serialize();
                   PoliceStuffandParkingPayment.printTickets.close();
    ...
    public static void showPlatformSimulation(int platformNumber)
    {
    ...
    public static void addVehicleOnStart(String type)
    {
        Stage window=new Stage();
    ...
    public static void chooseAndExit()
    {
        Random random=new Random();
